...
from ...tests.model_suggester.suggester_example_variables import TEST_VARIABLE_LISTS as lists
from ...tests.model_suggester.suggester_example_variables import TEST_PAIRS as pairs
...
class TestModelSuggester(object):
    ...
    def test_suggest_domain_expertises(self):
        ...
        expected_result = lists["list1_expected_domain_expertises"]
        expected_result = [f"<domain_expertise>{var}</domain_expertise>" for var in expected_result]
        expected_result = " ".join(expected_result)
        mock_llm.__getitem__ = MagicMock(return_value=expected_result)
        result = modeler.suggest_domain_expertises(lists["list1"])
        assert result == lists["list1_expected_domain_expertises"]
    ...
    def test_suggest_parents(self):
        ...
        expected_result = " ".join(expected_result)
        mock_llm.__getitem__ = MagicMock(return_value=expected_result)
        result = modeler.suggest_parents(lists["list1_expected_domain_expertises"][0], "ice cream sales", lists["list1"])
    ...
    def test_suggest_children(self):
        ...
        expected_result = " ".join(expected_result)
        mock_llm.__getitem__ = MagicMock(return_value=expected_result)
        result = modeler.suggest_children(lists["list1_expected_domain_expertises"][0], "ice cream sales", lists["list1"])
    ...
    def test_suggest_pairwise_relationship(self):
        ...
        result = modeler.suggest_pairwise_relationship(lists["list1_expected_domain_expertises"][0], pairs["test_a_cause_b"][0], pairs["test_a_cause_b"][1])
        ...
        result = modeler.suggest_pairwise_relationship(lists["list1_expected_domain_expertises"][0], pairs["test_b_cause_a"][0], pairs["test_b_cause_a"][1])
        ...
        result = modeler.suggest_pairwise_relationship(lists["list1_expected_domain_expertises"][0], pairs["test_no_causality"][0], pairs["test_no_causality"][1])
